...
public class createMasterDataSheet {
    ...
    public static void main(String[] args) throws IOException {
        ...
        createMasterDataSheet objCreateMasterDataSheet = new createMasterDataSheet();

        String strFolderPath = "C:\\GitCat\\testStandard\\Airports\\Datafiles\\Airports\\ACS";
        ...
        else
        {
           ...
           if (intFileCount > 0)
           {
               ...
               objCreateMasterDataSheet.writeDataToExcel();
                        ...
                        for(int intCellCounter = intCellStart;intCellCounter < intCellEnd;intCellCounter++)
                        {
                            ...
                            if (!(objFirstRowCell.getCellTypeEnum() == CellType.BLANK))
                            {
                               ...
                               // String strVariableValue = objCell.toString();
                                ...
                                variableMap.put(strVariable, strVariableValue);     //CASE INSENSITIVITY CHANGE.
                            }
                            else {
                                if(intCellCounter == intCellStart) {
                                    blnAddToMap = false;
